...
//
$sql = "SELECT u.username, u.user_id, u.user_posts, u.user_custom_title, u.user_from, u.user_website, u.user_email, u.user_icq, u.user_aim, u.user_yim, u.user_regdate, u.user_msnm, u.user_viewemail, u.user_rank, u.user_sig, u.user_sig_bbcode_uid, u.user_avatar, u.user_avatar_type, u.user_allowavatar, u.user_allowsmile, p.*,  pt.post_text, pt.post_subject, pt.bbcode_uid
...
for($i = 0; $i < $total_posts; $i++)
{
    ...
    if ( $poster_id != ANONYMOUS )
    {
        ...
        if ( !empty($postrow[$i]['user_viewemail']) || $is_auth['auth_mod'] )
        {
            ...
            $email_uri = ( $board_config['board_email_form'] ) ? append_sid("profile.$phpEx?mode=email&amp;" . POST_USERS_URL .'=' . $poster_id) : 'mailto:' . $email_nospam;
