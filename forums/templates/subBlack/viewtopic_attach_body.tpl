...
td.attachheader     { font: normal 11px Verdana, Arial, Helvetica, sans-serif; color : {T_BODY_TEXT}; border-color : {T_BODY_TEXT}; background-image: url(templates/subBlack/images/{T_TH_CLASS1}); }
