...
td.rowpic {
		...
		background-image: url(../templates/subBlack/images/sScellpic2.jpg);
...
th	{
	...
	background-image: url(../templates/subBlack/images/sScellpic3.gif);
}

td.cat,td.catHead,td.catSides,td.catLeft,td.catRight,td.catBottom {
			background-image: url(../templates/subBlack/images/sScellpic1.gif);
