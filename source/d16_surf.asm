...
Lblockloop16_mip0:
 ...
 mov ch,dh
 add edx,ebp
 mov ax,word ptr[12345678h+ebx*2]
LPatch0:
 mov bl,byte ptr[13+esi]
 ror eax,16
 mov ax,word ptr[12345678h+ecx*2]
LPatch1:
