...
Copyright (C) 2000-2001 Jānis Legzdiņš
...
void emit_1_or_2_operandsl_vartext (char *str0, char *str1)
{
	...
	{
		if (!stricmp (tokens[2], "%st(0)") || !stricmp (tokens[2], "%st"))
			printf (" %s ", str0);
		else
			printf (" %s ", str1);
...
parsefield	parsedata[] = {
	{".align", " align", 2, emit_multiple_data},//emitonedata},
	...
	{"fchs",   " fchs", -1, emit_0_or_1_operandsl},
	...
	{"fdivs",  " fdiv", -2, emit_1_or_2_operandsl},
	...
	{"fucompp", "fucompp", -1, emit_0_or_1_operandsl},
	{"fxch",   " fxch", 2, emitoneoperandl},
	{"imull",  " imul", -2, emit_1_or_2_operandsl},
	{"idivl",  " idiv", -2, emit_1_or_2_operandsl},
	...
	{"movd",   " movd", 3, emittwooperandsl},
	{"movl",   " mov", 3, emittwooperandsl},
	{"movq",   " movq", 3, emittwooperandsq},
	{"movswl", " movsx", 3, emittwooperandswl},
	{"movw",   " mov", 3, emittwooperandsw},
	{"movzbl", " movzx", 3, emittwooperandsbl},
	{"movzwl", " movzx", 3, emittwooperandswl},
	{"mull",   " mul", -2, emit_1_or_2_operandsl},
	{"negl",   " neg", 2, emitoneoperandl},
	{"notl",   " not", 2, emitoneoperandl},
	{"orb",    " or", 3, emittwooperandsb},
	{"orl",    " or", 3, emittwooperandsl},
	{"orw",    " or", 3, emittwooperandsw},
	{"packssdw", " packssdw", 3, emittwooperandsl},
	{"paddd",  " paddd", 3, emittwooperandsl},
	{"psrld",  " psrld", 3, emittwooperandsl},
	{"popl",   " pop", 2, emitoneoperandl},
	{"pushl",  " push", 2, emitoneoperandl},
	{"ret",    " ret", -1, emit_0_or_1_operandsl},
	{"rorl",   " ror", 3, emittwooperandsl},
	{"sahf",   " sahf", -1, emit_0_or_1_operandsl},
	{"salb",   " sal", 3, emittwooperandsb},
	{"sall",   " sal", 3, emittwooperandsl},
	{"salw",   " sal", 3, emittwooperandsw},
	{"sarb",   " sar", 3, emittwooperandsb},
	{"sarl",   " sar", 3, emittwooperandsl},
	{"sarw",   " sar", 3, emittwooperandsw},
	{"sbbl",   " sbb", 3, emittwooperandsl},
	{"seta",   " seta", 2, emitoneoperandb},
	{"setae",  " setae", 2, emitoneoperandb},
	{"setb",   " setb", 2, emitoneoperandb},
	{"setbe",  " setbe", 2, emitoneoperandb},
	{"sete",   " sete", 2, emitoneoperandb},
	{"setg",   " setg", 2, emitoneoperandb},
	{"setge",  " setge", 2, emitoneoperandb},
	{"setnb",  " setnb", 2, emitoneoperandb},
	{"setne",  " setne", 2, emitoneoperandb},
	{"setnl",  " setnl", 2, emitoneoperandb},
	{"setl",   " setl", 2, emitoneoperandb},
	{"setle",  " setle", 2, emitoneoperandb},
	{"shll",   " shl", 3, emittwooperandsl},
	{"shlw",   " shl", 3, emittwooperandsw},
	{"shrl",   " shr", 3, emittwooperandsl},	
	{"shrw",   " shr", 3, emittwooperandsw},
	{"subl",   " sub", 3, emittwooperandsl},
	{"testb",  " test", 3, emittwooperandsb},
	{"testl",  " test", 3, emittwooperandsl},
	{"testw",  " test", 3, emittwooperandsw},
	...
	for ( ;; )
	{
		...
		case LINE_DONE:
			if (!firsttoken && tokennum)
			{
				...
				{
					if (!stricmp (tokens[0], parsedata[i].text))
					{
