...
L2x2_2:
 ...
 mov dword ptr[edi+ebx*1],ecx
L2x2_3:
 cmp word ptr[2+edx+esi*1],bp
 jg L2x2_4
 mov word ptr[2+edx+esi*1],bp
 mov dword ptr[4+edi+ebx*1],ecx
L2x2_4:
 pop esi
 jmp LDone
 align 4
...
L4x4_7:
 ...
 mov dword ptr[12+edi+ebx*1],ecx
L4x4_8:
