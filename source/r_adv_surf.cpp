...
//**	   #    ##    ##    #      ####     ####   ##       ##
//**
//**	$Id: r_surf.cpp 4046 2009-07-31 15:05:54Z firebrand_kh $
//**
...
//==========================================================================
//
//	VAdvancedRenderLevel::SetupSky
//
//==========================================================================

void VAdvancedRenderLevel::SetupSky()
{
	guard(VAdvancedRenderLevel::SetupSky);
	skyheight = -99999.0;
...
sec_surface_t* VAdvancedRenderLevel::CreateSecSurface(subsector_t* sub,
	sec_plane_t* InSplane)
{
	guard(VAdvancedRenderLevel::CreateSecSurface);
...
//==========================================================================
//
//	VAdvancedRenderLevel::UpdateSecSurface
//
//==========================================================================

void VAdvancedRenderLevel::UpdateSecSurface(sec_surface_t *ssurf,
	sec_plane_t* RealPlane, subsector_t* sub)
{
	guard(VAdvancedRenderLevel::UpdateSecSurface);
...
//==========================================================================
//
//	VAdvancedRenderLevel::NewWSurf
//
//==========================================================================

surface_t* VAdvancedRenderLevel::NewWSurf()
{
	guard(VAdvancedRenderLevel::NewWSurf);
	if (!free_wsurfs)
	{
...
//==========================================================================
//
//	VAdvancedRenderLevel::FreeWSurfs
//
//==========================================================================

void VAdvancedRenderLevel::FreeWSurfs(surface_t* InSurfs)
{
...
//==========================================================================
//
//	VAdvancedRenderLevel::CreateWSurfs
//
//==========================================================================

surface_t* VAdvancedRenderLevel::CreateWSurfs(TVec* wv, texinfo_t* texinfo,
	seg_t* seg, subsector_t* sub)
{
	guard(VAdvancedRenderLevel::CreateWSurfs);
...
//==========================================================================
//
//	VAdvancedRenderLevel::CountSegParts
//
//==========================================================================

int VAdvancedRenderLevel::CountSegParts(seg_t* seg)
{
	guard(VAdvancedRenderLevel::CountSegParts);
	if (!seg->linedef)
	{
		//	Miniseg
		return 0;
...
//==========================================================================
//
//	VAdvancedRenderLevel::CreateSegParts
//
//==========================================================================

void VAdvancedRenderLevel::CreateSegParts(drawseg_t* dseg, seg_t *seg)
{
	guard(VAdvancedRenderLevel::CreateSegParts);
	TVec		wv[4];
	segpart_t	*sp;
...
//==========================================================================
//
//	VAdvancedRenderLevel::UpdateRowOffset
//
//==========================================================================

void VAdvancedRenderLevel::UpdateRowOffset(segpart_t *sp, float RowOffset)
{
	guard(VAdvancedRenderLevel::UpdateRowOffset);
...
//==========================================================================
//
//	VAdvancedRenderLevel::UpdateTextureOffset
//
//==========================================================================

void VAdvancedRenderLevel::UpdateTextureOffset(segpart_t* sp, float TextureOffset)
{
	guard(VAdvancedRenderLevel::UpdateTextureOffset);
...
//==========================================================================
//
//	VAdvancedRenderLevel::UpdateDrawSeg
//
//==========================================================================

void VAdvancedRenderLevel::UpdateDrawSeg(drawseg_t* dseg)
{
	guard(VAdvancedRenderLevel::UpdateDrawSeg);
	seg_t *seg = dseg->seg;
	segpart_t *sp;
	TVec wv[4];
...
//==========================================================================
//
//	VAdvancedRenderLevel::SegMoved
//
//==========================================================================

void VAdvancedRenderLevel::SegMoved(seg_t* seg)
{
	guard(VAdvancedRenderLevel::SegMoved);
	if (!seg->drawsegs)
	{
...
//==========================================================================
//
//	VAdvancedRenderLevel::UpdateSubRegion
//
//==========================================================================

void VAdvancedRenderLevel::UpdateSubRegion(subregion_t* region)
{
	guard(VAdvancedRenderLevel::UpdateSubRegion);
	int				count;
	int 			polyCount;
	seg_t**			polySeg;
...
//==========================================================================
//
//	VAdvancedRenderLevel::CopyPlaneIfValid
//
//==========================================================================

bool VAdvancedRenderLevel::CopyPlaneIfValid(sec_plane_t* dest,
...
//==========================================================================
//
//	VAdvancedRenderLevel::UpdateFakeFlats
//
...
void VAdvancedRenderLevel::UpdateFakeFlats(sector_t* sec)
{
	guard(VAdvancedRenderLevel::UpdateFakeFlats);
...
//==========================================================================
//
//	VAdvancedRenderLevel::SetupFakeFloors
//
//==========================================================================

void VAdvancedRenderLevel::SetupFakeFloors(sector_t* Sec)
{
	guard(VAdvancedRenderLevel::SetupFakeFloors);
...
//==========================================================================
//
//	VAdvancedRenderLevel::FreeSurfaces
//
//==========================================================================

void VAdvancedRenderLevel::FreeSurfaces(surface_t* InSurf)
{
	guard(VAdvancedRenderLevel::FreeSurfaces);
	surface_t* next;
...
//==========================================================================
//
//	VAdvancedRenderLevel::FreeSegParts
//
//==========================================================================

void VAdvancedRenderLevel::FreeSegParts(segpart_t* ASP)
{
	guard(VAdvancedRenderLevel::FreeSegParts);
