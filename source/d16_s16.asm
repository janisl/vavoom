...
LSetUp1:
 ...
 add dword ptr[advancetable+4],2
 add dword ptr[advancetable+12],2
 ...
 add edx,dword ptr[tstep]
 sbb ecx,ecx
 mov byte ptr[10+edi],al
 mov byte ptr[11+edi],ah
 add ebx,ebp
 adc ecx,ecx
 mov al,byte ptr[esi]
 mov ah,byte ptr[1+esi]
 ...
 add edx,dword ptr[tstep]
 sbb ecx,ecx
 mov byte ptr[14+edi],al
 mov byte ptr[15+edi],ah
 add ebx,ebp
 adc ecx,ecx
 mov al,byte ptr[esi]
 mov ah,byte ptr[1+esi]
...
LFDIVInFlight2:
 ...
 add edx,dword ptr[tstep]
 sbb ecx,ecx
 mov byte ptr[18+edi],al
 mov byte ptr[19+edi],ah
 add ebx,ebp
 adc ecx,ecx
 mov al,byte ptr[esi]
 mov ah,byte ptr[1+esi]
 ...
 add edx,dword ptr[tstep]
 sbb ecx,ecx
 mov byte ptr[22+edi],al
 mov byte ptr[23+edi],ah
 add ebx,ebp
 adc ecx,ecx
 mov al,byte ptr[esi]
 mov ah,byte ptr[1+esi]
 ...
 add edx,dword ptr[tstep]
 sbb ecx,ecx
 mov byte ptr[26+edi],al
 mov byte ptr[27+edi],ah
 add ebx,ebp
 adc ecx,ecx
 mov al,byte ptr[esi]
 mov ah,byte ptr[1+esi]
...
LEndSpan:
 ...
 test ebx,ebx
 mov byte ptr[30+edi],al
 mov byte ptr[31+edi],ah
 jnz LSpanLoop
 pop ebx
 pop esi
 pop edi
