...
_D_DrawSurfaceBlock8RGB_mip0:
 mov eax,dword ptr[_pbasesource]
 sub esp,60
 mov edx,dword ptr[_prowdestbase]
 push ebp
 push edi
 push esi
 push ebx
 ...
 cmp esi,dword ptr[_r_numvblocks]
 jge L1013
L1000:
...
L1004:
 mov ecx,dword ptr[_lightrright]
 mov esi,dword ptr[_lightrleft]
 mov edx,dword ptr[_lightgright]
 mov edi,dword ptr[_lightgleft]
 mov eax,dword ptr[_lightbright]
 sub esi,ecx
 sar esi,4
 mov dword ptr[56+esp],esi
 mov esi,dword ptr[_lightbleft]
 sub edi,edx
 sar edi,4
...
L1008:
 ...
 and eax,65280
 add eax,ebx
 mov cx,word ptr[12345678h+ecx*2]
LRPatch0:
 or cx,word ptr[12345678h+eax*2]
LGPatch0:
 mov eax,ebp
 and eax,65280
 add eax,ebx
...
LTPatch0:
 ...
 add dword ptr[44+esp],esi
 add ebp,dword ptr[40+esp]
 dec edi
 and ecx,65280
 xor ebx,ebx
...
LTPatch1:
 ...
 add dword ptr[52+esp],ecx
 add dword ptr[44+esp],ebx
 add ebp,dword ptr[40+esp]
 add dword ptr[60+esp],offset -2
 jns L1008
 mov esi,dword ptr[_sourcetstep]
 mov eax,dword ptr[_lightrrightstep]
 add dword ptr[_lightrright],eax
 mov eax,dword ptr[_lightrleftstep]
 add dword ptr[_lightrleft],eax
 ...
 mov edi,dword ptr[_surfrowbytes]
 mov ebx,dword ptr[24+esp]
 add dword ptr[36+esp],esi
 ...
 jle L1004
 mov eax,dword ptr[36+esp]
 cmp eax,dword ptr[_r_sourcemax]
 jb L999
 mov edx,dword ptr[_r_stepback]
 sub eax,edx
 mov dword ptr[36+esp],eax
L999:
...
L1070:
 mov edi,dword ptr[_lightrright]
 mov eax,dword ptr[_lightrleft]
 mov esi,dword ptr[_lightgright]
 mov edx,dword ptr[_lightgleft]
 mov dword ptr[20+esp],edi
 sub eax,edi
 mov edi,dword ptr[_lightbright]
 mov ebx,dword ptr[_lightbleft]
 sar eax,1
...
LTPatch6:
 ...
 add esi,ecx
 add edi,ecx
 mov dx,word ptr[12345678h+ebx*2]
LRPatch7:
 or dx,word ptr[12345678h+esi*2]
LGPatch7:
 or dx,word ptr[12345678h+edi*2]
LBPatch7:
 and edx,65535
 mov edi,dword ptr[24+esp]
 mov al,byte ptr[12345678h+edx]
LTPatch7:
 mov byte ptr[edi],al
 mov eax,dword ptr[_sourcetstep]
 add dword ptr[28+esp],eax
 mov eax,dword ptr[_lightrrightstep]
 add dword ptr[_lightrright],eax
 mov eax,dword ptr[_lightrleftstep]
 add dword ptr[_lightrleft],eax
 ...
 add dword ptr[_lightbright],eax
 mov eax,dword ptr[_lightbleftstep]
 mov edx,dword ptr[_surfrowbytes]
 add dword ptr[_lightbleft],eax
 add edi,edx
 ...
 jle L1070
 mov ebx,dword ptr[28+esp]
 cmp ebx,dword ptr[_r_sourcemax]
 jb L1065
 mov edi,dword ptr[_r_stepback]
 sub ebx,edi
